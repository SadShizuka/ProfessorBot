...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [ 
	    InlineKeyboardButton(text="⚡ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://telegram.me/HeroTutorial')
        ] 
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('♥️ Love @HerPlix1 ♥️')
            else:
                await query.message.edit_text(
                    "I'm not connected to any groups!\nCheck /connections or connect to any groups",
                    quote=True
                )
                return await query.answer('♥️ Thank You HeroPlix ♥️')
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇs', url='https://t.me/HeroPlix1')
        ], [
            InlineKeyboardButton('ℹ ʜᴇʟᴘ', callback_data='help'),
            InlineKeyboardButton('☺ ᴀʙᴏᴜᴛ', callback_data='about')
        ],[
            InlineKeyboardButton('😚 ᴄᴏɴᴛᴀᴄᴛ ᴏᴡɴᴇʀ', url='https://t.me/Sad_Nobita')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        await query.answer('♥️ Thank You HeroPlix ♥️')
        ...
        try:
            btn = [[
                ...
                InlineKeyboardButton(text=f"🐞 REPORT ISSUE 🐞", url=f"https://telegram.me/HeroPlixGroup")
            ],[
                InlineKeyboardButton(text=f"⚡️ Contact Owner 🦋", url=f"https://t.me/Sad_Nobita")
        ...
        try:
            btn = [[
                ...
                InlineKeyboardButton(text=f"🐞 REPORT ISSUE 🐞", url=f"https://telegram.me/HeroPlix1")
            ],[
                InlineKeyboardButton(text=f"⚡️ Contact Owner 🦋", url=f"https://t.me/Sad_Nobita")
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0,
        [ 
	    InlineKeyboardButton(text="⚡ʜᴏᴡ 2 ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://telegram.me/HeroTutorial'),
        ] 
    )
    if offset != "":
